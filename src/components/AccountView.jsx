...
function Copyright(props) {
  return (
    <Typography variant="body2" color="text.secondary" align="center" {...props}>
      {'Copyright © '}
      <Link color="inherit" href="https://www.benbernardy.com">
        Ben Bernardy
      </Link>{' '}
...
export default function SignInSide() {
  ...
  const handleSubmit = (event) => {
    ...
    console.log("Should attempt to auth, then dispatch appropriate value to store")
    console.log("Data:  ", data)
    dispatch({type:"AUTHORIZE", payload:true})
    dispatch({type:"CHANGE_VIEW", payload:"attendance"})
  };
