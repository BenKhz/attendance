...
module.exports = {
  ...
  // @ returns : Array of all row results DB
  getEnrollment: (cb) => {
    return db.query(`SELECT * FROM enrollment`, (err, rows) => {
  ...
  getTodaysAttendance : (payload, cb) => { // Should get
    ...
    console.log("Sould reach out to DB and return table of todays Attendance")
  },
}